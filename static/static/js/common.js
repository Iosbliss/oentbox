...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (searchOverlay) {
    ...
    searchOverlay.setAttribute('aria-label', 'Search titles');
  }
  ...
  const savedButtons = [...document.querySelectorAll('.js-my-list-button[data-movie-id]')];
  ...
  if (savedButtons.length) syncAccountSaved();
